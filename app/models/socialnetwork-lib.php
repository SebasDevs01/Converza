...
// La conexión PDO ya está definida en config.php y disponible como $conexion

// ✅ Avatar por defecto si no existe
if (!isset($_SESSION['avatar']) || empty($_SESSION['avatar'])) {
  $_SESSION['avatar'] = "defect.jpg"; // asegúrate que este archivo exista en /avatars/
}
...
function Headerb() {
  ...
  $avatar   = !empty($userData['avatar']) ? $userData['avatar'] : "defect.jpg";
